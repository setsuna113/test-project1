import os
import torch
from model_ncnn_compat import Pytorch_DTLN_P1_stateful, Pytorch_DTLN_P2_stateful

# pip install -U onnx==1.15.0 onnxoptimizer onnxruntime==1.15.0
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path",
                        type=str,
                        help="model dir",
                        default=os.path.dirname(__file__) + "/results/4234/save/CKPT+2024-01-10+16-00-29+00/model.ckpt")
    ...
    torch.onnx.export(model1,
                      ...
                      args.model_1,
                      input_names=input_names, output_names=output_names, opset_version=16)
